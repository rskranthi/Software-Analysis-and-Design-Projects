 ...
 * <ul>
 *   <li>{@link vendingMachine.vendingMachine.extern.Product#getM_iID <em>MiID</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.extern.Product#getM_sName <em>MsName</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.extern.Product#getM_sDescription <em>MsDescription</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.extern.Product#getM_dPrice <em>MdPrice</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.extern.Product#getM_iQuantity <em>MiQuantity</em>}</li>
 * </ul>
 * </p>
 *
 * @see vendingMachine.vendingMachine.extern.ExternPackage#getProduct()
 * @model
 * @generated
 */
public interface Product extends IProductInfo {
	 ...
	 * @see #setM_iID(int)
	 * @see vendingMachine.vendingMachine.extern.ExternPackage#getProduct_M_iID()
	 * @model
	 * @generated
	 */
	int getM_iID();
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.extern.Product#getM_iID <em>MiID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.extern.ExternPackage#getProduct_M_sName()
	 * @model
	 * @generated
	 */
	String getM_sName();
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.extern.Product#getM_sName <em>MsName</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.extern.ExternPackage#getProduct_M_sDescription()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.extern.Product#getM_sDescription <em>MsDescription</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.extern.ExternPackage#getProduct_M_dPrice()
	 * @model
	 * @generated
	 */
	double getM_dPrice();
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.extern.Product#getM_dPrice <em>MdPrice</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.extern.ExternPackage#getProduct_M_iQuantity()
	 * @model
	 * @generated
	 */
	int getM_iQuantity();
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.extern.Product#getM_iQuantity <em>MiQuantity</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
