...
import vendingMachine.vendingMachine.VendingMachinePackage;
import vendingMachine.vendingMachine.extern.ExternPackage;

import vendingMachine.vendingMachine.extern.impl.ExternPackageImpl;

import vendingMachine.vendingMachine.vendsys.CashRegister;
import vendingMachine.vendingMachine.vendsys.CoinCount;
import vendingMachine.vendingMachine.vendsys.IOutputDisplayListener;
...
import vendingMachine.vendingMachine.vendsys.IProductDispenserListener;
...
import vendingMachine.vendingMachine.vendsys.VendsysFactory;
...
public class VendsysPackageImpl extends EPackageImpl implements VendsysPackage {
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		// Create annotations
		// has
		createHasAnnotations();
	}

	/**
	 * Initializes the annotations for <b>has</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createHasAnnotations() {
		String source = "has";	
		addAnnotation
		  (getPayMachine__InsertDime(), 
		   source, 
		   new String[] {
			 "m_dBalance", "3.00"
		   },
		   new URI[] {
			 URI.createURI(VendingMachinePackage.eNS_URI).appendFragment("//vendsys/PayMachine/insertDime"),
			 URI.createURI(VendingMachinePackage.eNS_URI).appendFragment("//vendsys/CashRegister/takeOutChange/dAmount")
		   });
	}
