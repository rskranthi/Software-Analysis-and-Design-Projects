...
import vendingMachine.vendingMachine.vendsys.IPayMachineListener;
 ...
 * <ul>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.impl.PayMachineImpl#getM_dMaximumBalance <em>MdMaximum Balance</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.impl.PayMachineImpl#getM_dBalance <em>MdBalance</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.impl.PayMachineImpl#isM_bOutOfOrder <em>MbOut Of Order</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.impl.PayMachineImpl#getM_pmlListener <em>Mpml Listener</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.impl.PayMachineImpl#getM_crRegister <em>Mcr Register</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.impl.PayMachineImpl#getM_vvmOwner <em>Mvvm Owner</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
double dNewBalance = m_dBalance + 1.00;
	...
	public void returnChange() {
		...
		if (m_pmlListener != null)
		{
			m_pmlListener.returnChange(ccChange.getNUM_QUARTERS(),ccChange.getNUM_DIMES(),ccChange.getNUM_NICKELS());
