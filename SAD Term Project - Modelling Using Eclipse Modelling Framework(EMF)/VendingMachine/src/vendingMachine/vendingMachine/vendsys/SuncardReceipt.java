 ...
 * <ul>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.SuncardReceipt#getM_iAccount <em>MiAccount</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.SuncardReceipt#getM_dAmountDeducted <em>MdAmount Deducted</em>}</li>
 * </ul>
 * </p>
 *
 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getSuncardReceipt()
 * @model
 * @generated
 */
public interface SuncardReceipt extends EObject {
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getSuncardReceipt_M_iAccount()
	 * @model
	 * @generated
	 */
	int getM_iAccount();
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.SuncardReceipt#getM_iAccount <em>MiAccount</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getSuncardReceipt_M_dAmountDeducted()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.SuncardReceipt#getM_dAmountDeducted <em>MdAmount Deducted</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
