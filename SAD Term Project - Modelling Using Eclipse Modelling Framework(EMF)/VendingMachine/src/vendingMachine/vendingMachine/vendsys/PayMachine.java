 ...
 * <ul>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_dMaximumBalance <em>MdMaximum Balance</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_dBalance <em>MdBalance</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.PayMachine#isM_bOutOfOrder <em>MbOut Of Order</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_pmlListener <em>Mpml Listener</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_crRegister <em>Mcr Register</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_vvmOwner <em>Mvvm Owner</em>}</li>
 * </ul>
 * </p>
 *
 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getPayMachine()
 * @model
 * @generated
 */
public interface PayMachine extends EObject {
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getPayMachine_M_dMaximumBalance()
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_dMaximumBalance <em>MdMaximum Balance</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_dMaximumBalance <em>MdMaximum Balance</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetM_dMaximumBalance()
	 * @see #getM_dMaximumBalance()
	...
	/**
	 * Returns whether the value of the '{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_dMaximumBalance <em>MdMaximum Balance</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getPayMachine_M_dBalance()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_dBalance <em>MdBalance</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getPayMachine_M_bOutOfOrder()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.PayMachine#isM_bOutOfOrder <em>MbOut Of Order</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getPayMachine_M_pmlListener()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_pmlListener <em>Mpml Listener</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getPayMachine_M_crRegister()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_crRegister <em>Mcr Register</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#getM_pmPayMachine <em>Mpm Pay Machine</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getPayMachine_M_vvmOwner()
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_vvmOwner <em>Mvvm Owner</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model annotation="has m_dBalance='3.00'"
	 * @generated
	 */
	void insertDime();
