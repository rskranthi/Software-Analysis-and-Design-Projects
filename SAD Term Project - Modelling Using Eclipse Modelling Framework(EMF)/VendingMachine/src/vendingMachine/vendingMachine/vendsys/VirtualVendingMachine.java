 ...
 * <ul>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#isM_bOutOfOrder <em>MbOut Of Order</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#getM_pdProducts <em>Mpd Products</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#getM_odOutputDisplay <em>Mod Output Display</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#getM_pdDispenser <em>Mpd Dispenser</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#getM_pmPayMachine <em>Mpm Pay Machine</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#getM_psProductSelector <em>Mps Product Selector</em>}</li>
 * </ul>
 * </p>
 *
 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getVirtualVendingMachine()
 * @model
 * @generated
 */
public interface VirtualVendingMachine extends EObject {
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getVirtualVendingMachine_M_bOutOfOrder()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#isM_bOutOfOrder <em>MbOut Of Order</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getVirtualVendingMachine_M_pdProducts()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#getM_pdProducts <em>Mpd Products</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Mod Output Display</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Mod Output Display</em>' containment reference.
	 * @see #setM_odOutputDisplay(OutputDisplay)
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getVirtualVendingMachine_M_odOutputDisplay()
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#getM_odOutputDisplay <em>Mod Output Display</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getVirtualVendingMachine_M_pdDispenser()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#getM_pdDispenser <em>Mpd Dispenser</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link vendingMachine.vendingMachine.vendsys.PayMachine#getM_vvmOwner <em>Mvvm Owner</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getVirtualVendingMachine_M_pmPayMachine()
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#getM_pmPayMachine <em>Mpm Pay Machine</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link vendingMachine.vendingMachine.vendsys.ProductSelector#getM_vvmMachine <em>Mvvm Machine</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getVirtualVendingMachine_M_psProductSelector()
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#getM_psProductSelector <em>Mps Product Selector</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
