 ...
 * <ul>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.ProductSelector#getM_pslListener <em>Mpsl Listener</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.ProductSelector#getM_piSelectedItem <em>Mpi Selected Item</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.ProductSelector#getM_vvmMachine <em>Mvvm Machine</em>}</li>
 * </ul>
 * </p>
 *
 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getProductSelector()
 * @model
 * @generated
 */
public interface ProductSelector extends EObject {
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getProductSelector_M_pslListener()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.ProductSelector#getM_pslListener <em>Mpsl Listener</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getProductSelector_M_piSelectedItem()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.ProductSelector#getM_piSelectedItem <em>Mpi Selected Item</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link vendingMachine.vendingMachine.vendsys.VirtualVendingMachine#getM_psProductSelector <em>Mps Product Selector</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getProductSelector_M_vvmMachine()
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.ProductSelector#getM_vvmMachine <em>Mvvm Machine</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
