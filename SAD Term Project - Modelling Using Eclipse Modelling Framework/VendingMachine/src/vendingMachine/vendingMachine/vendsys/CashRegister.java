 ...
 * <ul>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.CashRegister#getM_iNumQuarters <em>MiNum Quarters</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.CashRegister#getM_iNumDimes <em>MiNum Dimes</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.CashRegister#getM_iNumNickels <em>MiNum Nickels</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.CashRegister#getM_iNumDollars <em>MiNum Dollars</em>}</li>
 *   <li>{@link vendingMachine.vendingMachine.vendsys.CashRegister#getM_alReceipts <em>Mal Receipts</em>}</li>
 * </ul>
 * </p>
 *
 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getCashRegister()
 * @model
 * @generated
 */
public interface CashRegister extends VirtualVendingMachine {
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getCashRegister_M_iNumQuarters()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.CashRegister#getM_iNumQuarters <em>MiNum Quarters</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getCashRegister_M_iNumDimes()
	 * @model
	 * @generated
	 */
	int getM_iNumDimes();
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.CashRegister#getM_iNumDimes <em>MiNum Dimes</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getCashRegister_M_iNumNickels()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.CashRegister#getM_iNumNickels <em>MiNum Nickels</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getCashRegister_M_iNumDollars()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.CashRegister#getM_iNumDollars <em>MiNum Dollars</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Mal Receipts</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Mal Receipts</em>' containment reference.
	 * @see #setM_alReceipts(SuncardReceipt)
	 * @see vendingMachine.vendingMachine.vendsys.VendsysPackage#getCashRegister_M_alReceipts()
	...
	/**
	 * Sets the value of the '{@link vendingMachine.vendingMachine.vendsys.CashRegister#getM_alReceipts <em>Mal Receipts</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
