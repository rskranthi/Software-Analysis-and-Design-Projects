/**
 */
package vendingMachine.vendingMachine.extern.util;
...
import vendingMachine.vendingMachine.extern.*;
 ...
 * @generated
 */
public class ExternSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExternPackage.PRODUCT: {
				Product product = (Product)theEObject;
				T result = caseProduct(product);
				if (result == null) result = caseIProductInfo(product);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExternPackage.MY_PRODUCT_DATABASE: {
				MyProductDatabase myProductDatabase = (MyProductDatabase)theEObject;
				T result = caseMyProductDatabase(myProductDatabase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExternPackage.ICON: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>My Product Database</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>My Product Database</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMyProductDatabase(MyProductDatabase object) {
		return null;
	}
